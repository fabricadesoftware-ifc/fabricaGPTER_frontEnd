<script setup>
  ...
  import { ChevronRight, Info, LockKeyhole, LogOut, Phone } from 'lucide-vue-next';
  ...
  const settings = ref([
    {
      name: 'Informações',
      icon: Info,
      link: '/patient/profile/infos',
    },
    {
      name: 'Alterar senha',
      icon: LockKeyhole,
      link: '/patient/profile/change-password',
    },
    {
      name: 'Termos de Uso',
      icon: Info,
      link: '/patient/profile/terms-of-use',
    },
    {
      name: 'Contato',
      icon: Phone,
      link: '/patient/profile/contact',
    },
    {
      name: 'Sair',
      icon: LogOut,
...
<template>
  ...
  <template v-if="smAndDown">
    <template v-if="route.name === '/patient/profile'">
